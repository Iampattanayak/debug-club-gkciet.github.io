    ...
    <div class="container pt-5">
        ...
        <div class="d-flex justify-content-center mb-5">
            <div class="nav-segment-container">
                ...
                <a href="/projects/web/" class="btn btn-brand btn-sm rounded-pill px-4 text-black fw-bold text-decoration-none nav-segment-item active">Web Dev</a>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            {% for project in site.data.projects.list %}
                {% if project.category == 'Web Dev' or project.category == 'Official' %}
            ...
            <div class="col-12">
                <div class="glass-card p-5 text-center rounded-4 border-dashed border-secondary border-opacity-25">
                    <div class="mb-4">
                        <i class="fas fa-code-branch fa-3x text-muted opacity-50"></i>
                    </div>
                    <h3 class="fw-bold text-white mb-2">Cooking Something New</h3>
                    <p class="text-muted">No web projects launched yet. Check back soon or join us to build one!</p>
                </div>
            </div>
            {% endif %}
        </div>
