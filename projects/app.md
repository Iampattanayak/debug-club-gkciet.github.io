    ...
    <div class="container pt-5">
        ...
        <div class="d-flex justify-content-center mb-5">
            <div class="nav-segment-container">
                ...
                <a href="/projects/app/" class="btn btn-brand btn-sm rounded-pill px-4 text-black fw-bold text-decoration-none nav-segment-item active">App Dev</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                <div class="glass-card p-5 text-center rounded-4 border-dashed border-secondary border-opacity-25">
                    <div class="mb-4">
                        <i class="fas fa-mobile-alt fa-3x text-muted opacity-50"></i>
                    </div>
                    <h3 class="fw-bold text-white mb-2">Building Apps...</h3>
                    <p class="text-muted">Mobile applications are currently in development. Watch this space!</p>
                </div>
            </div>
            {% endif %}
        </div>
